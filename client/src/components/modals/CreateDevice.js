            ...
            <Modal.Body>
                <Form>
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{device.selectedType.name || "Оберіть тип товару"}</Dropdown.Toggle>
                        <Dropdown.Menu>
                    ...
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{device.selectedBrand.name || "Оберіть тип товару"}</Dropdown.Toggle>
                        <Dropdown.Menu>
